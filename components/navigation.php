<header class="header">
  ...
  <div class="py-2 bg-dark text-white">
    <div class="container py-1">
      <div class="row align-items-center">
        ...
        <li class="list-inline-item"><a class="reset-anchor" href="components/logout.php">Logout</a></li>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white py-4">
    <div class="container text-center"><a class="navbar-brand mx-auto" href="index.php"><img class="mb-2" src="img/logo.svg" alt="" width="140">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item px-1">
            <!-- Link--><a class="nav-link" href="listing.php">Listing</a>
          </li>
          <li class="nav-item px-1">
            <!-- Link--><a class="nav-link" href="post.php">Post</a>
          </li>
          <li class="nav-item px-1 dropdown"><a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pages</a>
            <div class="dropdown-menu text-center text-lg-left" aria-labelledby="navbarDropdownMenuLink"><a class="dropdown-item" href="index.php">Home</a><a class="dropdown-item" href="listing.php">Listing</a><a class="dropdown-item" href="post.php">Post</a></div>
          </li>
        </ul>
      </div>
    </div>
